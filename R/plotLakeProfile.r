...
# Cast to matrix
prof_matrix=reshape2::dcast(MonitoringLocationIdentifier+ActivityIdentifier+ActivityStartDate+get(line_no)~param_name, value.var=paste(value_var), data=data)
