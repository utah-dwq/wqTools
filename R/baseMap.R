...
baseMap=function(layers_control=TRUE){
	...
	addPolygons(data=wqTools::au_poly,group="Assessment units",smoothFactor=2,fillOpacity = 0.1,weight=3,color="orange", options = pathOptions(pane = "au_poly"),
		popup=paste0(
	...
	addPolygons(data=wqTools::ut_poly,group="UT boundary",smoothFactor=2,fillOpacity = 0.1,weight=3,color="purple", options = pathOptions(pane = "underlay_polygons")) %>%
